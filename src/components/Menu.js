...
function Menu() {
  ...
  return (
    <section className="menu">
      <h1>
        Choose an option: 
        <SayButton speak="Choose an option:" rate={0.8}>
      ...
      <div className="menuItem">
        ...
        <SayButton speak="Addition" rate={0.8} className="speechContainer">
          <FontAwesomeIcon className="speechBtn" icon={faVolumeUp} />
        </SayButton>
      </div>
      ...
      <div className="menuItem">
        ...
        <SayButton speak="Subtraction" rate={0.8}>
          <FontAwesomeIcon className="speechBtn" icon={faVolumeUp} />
        </SayButton>
      </div>
      ...
      <div className="menuItem">
        ...
        <SayButton speak="Multiplication" rate={0.8}>
          <FontAwesomeIcon className="speechBtn" icon={faVolumeUp} />
        </SayButton>
      </div>
      ...
      <div className="menuItem">
        ...
        <SayButton speak="Division" rate={0.8}>
          <FontAwesomeIcon className="speechBtn" icon={faVolumeUp} />
        </SayButton>
      </div>
    </section>
