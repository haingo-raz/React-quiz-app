        ...
        <>
            ...
            <div className="modalContainer">
                <div className="content">
                    <Link to="/" className="close" onClick={onClose}>
                        X
                    </Link>
                    <img
                        src="https://i0.wp.com/armeehistoire.fr/wp-content/uploads/2022/11/archimede.png?resize=750%2C750&ssl=1"
                        alt="cookies-img"
                    />
                    ...
                    <Link to="/" className="menuBtn" onClick={onClose}>
                        Return to menu
                    </Link>
                </div>
            </div>
